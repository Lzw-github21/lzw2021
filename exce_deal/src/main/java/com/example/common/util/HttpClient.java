...
//
//
//    public HttpEntityDto doGetTestOne(String url) {
//        HttpEntityDto httpEntityDto = new HttpEntityDto();
//
...
//            //获取响应状态
//            httpEntityDto.setMessage("运行正常");
//            httpEntityDto.setStatus(response.getStatusLine().getStatusCode());
//        } catch (ParseException | IOException e) {
//            httpEntityDto.setStatus(404);
//            httpEntityDto.setMessage(e.getMessage());
//        } finally {
//            try {
//                // 释放资源
//                if (httpClient != null) {
